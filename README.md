...
Multi-turn conversation manager for C++. Single header, libcurl required.
...
| File | Description |
|------|-------------|
| basic_chat.cpp | Two-turn chat |
| persistent_chat.cpp | Save/restore history |
| token_budget.cpp | Truncation demo |
